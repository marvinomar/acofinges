 ...
 * FosUserUser
 *
 * @ORM\Table(name="fos_user_user", uniqueConstraints={@ORM\UniqueConstraint(name="fos_user_user_idx1", columns={"username"})}, indexes={@ORM\Index(name="fos_user_user_idx", columns={"username"})})
 * @ORM\Entity
 */
class FosUserUser
{
     ...
     * @var string
     *
     * @ORM\Column(name="facebook_data", type="string", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="twitter_data", type="string", nullable=true)
     */
    private $twitterData;
     ...
     * @var string
     *
     * @ORM\Column(name="gplus_data", type="string", nullable=true)
     */
    private $gplusData;
